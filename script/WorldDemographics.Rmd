...
output: 
  flexdashboard::flex_dashboard:
    ...
    source_code: "https://github.com/soledadferreras/WorldDemographics"
    theme : "spacelab"
...
transpo_Countries %>%
  ...
  plot_geo(locationmode = "country names",  reversescale = T) %>%
  add_trace(
